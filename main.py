...
def configure():
 ...
 #   flags.DEFINE_string("model_name", 'low_rank', "vanilla or low_rank")
    ...
    flags.DEFINE_string("modeldir", './modeldir_ssim', "the model directory")
    flags.DEFINE_string("logdir", './logdir_ssim', "the log directory")
    flags.DEFINE_string("sampledir", './sampledir_ssim', "the sample directory")
